...
- Adopting the corrected valency lookup table from Nikitin et al. for **QMe14S** (14 elements), which correctly handles multi-valent elements such as S (valency 2, 3, or 6), P (valency 3 or 5).
